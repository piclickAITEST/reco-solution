...
Piclick.prototype = {
  ...
  sirsPC2: function (productID, mainImgUrl, referer) {
    ...
    iframe.src = 'https://ai.piclick.kr/sirs/shescloset_pc/' + productID + '?uid=' + self.uid + '&cookieID=' + self.uid + '&contentUrl=' + mainImgUrl;
    iframe.width = "100%";
    iframe.display = 'none';
    iframe.height = "420px";
    ...
    document.querySelector('.detailArea').appendChild(piclick_div);
  ...
  sirsMobile2: function (productID, mainImgUrl, referer) {
    ...
    var iframe = document.createElement('iframe');
    iframe.id = 'piclick-sirs-iframe';
    iframe.src = 'https://ai.piclick.kr/sirs/shescloset/' + productID + '?uid=' + self.uid + '&cookieID=' + self.uid + '&contentUrl=' + mainImgUrl;
    iframe.width = "100%";
    iframe.display = 'none';
    iframe.height = "0px";
    iframe.frameBorder = "0";
    ...
    piclick_div.appendChild(iframe);
    document.querySelector('.snsLink').after(piclick_div);
  ...
  allowButtons: function () {
    document.querySelector('div.control > span.next').addEventListener("click", function (e) {
      if (document.location.href.indexOf('&psr=reco_ai') > -1) {
        e.preventDefault();
        document.location.replace(document.location.href.replace('&psr=reco_ai', ''));
        $(this).click();
      }
    })

    document.querySelector('div.control > span.prev').addEventListener("click", function () {
      if (document.location.href.indexOf('&psr=reco_ai') > -1) {
        e.preventDefault();
        document.location.replace(document.location.href.replace('&psr=reco_ai', ''));
        $(this).click();
