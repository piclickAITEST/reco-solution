...
Piclick.prototype = {
  ...
  sirsPC2: function (productID, mainImgUrl, referer) {
    ...
    iframe.src = 'https://ai.piclick.kr/sirs/april9_pc/' + productID + '?uid=' + self.uid + '&cookieID=' + self.uid + '&contentUrl=' + mainImgUrl;
    iframe.width = "100%";
    iframe.display = 'none';
    iframe.height = "0px";
    ...
    if(document.querySelector('.srlite_container')){
      finder = true;
      document.querySelector('.srlite_container').before(piclick_div);
    }else{
      finditv = setInterval(function(){
        if(!finder && document.querySelector('.srlite_container')){
          finder = true;
  ...
  sirsMobile2: function (productID, mainImgUrl, referer) {
    ...
    var iframe = document.createElement('iframe');
    iframe.id = 'piclick-sirs-iframe';
    iframe.src = 'https://ai.piclick.kr/sirs/april9/' + productID + '?uid=' + self.uid + '&cookieID=' + self.uid + '&contentUrl=' + mainImgUrl;
    iframe.width = "100%";
    iframe.display = 'none';
    iframe.height = "0px";
    iframe.frameBorder = "0";
    ...
    piclick_div.appendChild(iframe);
    document.querySelector('#etc-button').after(piclick_div);
