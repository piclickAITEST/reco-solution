...
Piclick.prototype = {
  ...
  sirsPC2: function (productID, mainImgUrl, referer) {
    ...
    iframe.src = 'https://ai.piclick.kr/sirs/joymadam_pc/' + productID + '?uid=' + self.uid + '&cookieID=' + self.uid + '&contentUrl=' + mainImgUrl;
    iframe.width = "100%";
    iframe.display = 'none';
    iframe.height = "430px";
  ...
  sirsMobile2: function (productID, mainImgUrl, referer) {
    ...
    var iframe = document.createElement('iframe');
    iframe.id = 'piclick-sirs-iframe';
    iframe.src = 'https://ai.piclick.kr/sirs/joymadam/' + productID + '?uid=' + self.uid + '&cookieID=' + self.uid + '&contentUrl=' + mainImgUrl;
    iframe.width = "100%";
    iframe.display = 'none';
    iframe.height = "0px";
    iframe.frameBorder = "0";
    ...
    var list = document.querySelector('.prdDesc');
    list.insertBefore(iframe, list.childNodes[12]);
