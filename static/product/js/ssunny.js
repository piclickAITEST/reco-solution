...
Piclick.prototype = {
  ...
  checkParams: function (site_name, mainImg, subImg) {
    ...
    if (site_name !== undefined && mainImg !== undefined && subImg !== undefined) {
      ...
      urls.push("https://www.ssunny.co.kr" + imgUrl);
      return urls
    }
    else return false;
  },
  ...
  sirsPC2: function (productID, mainImgUrl, referer) {
    ...
    iframe.src = 'https://ai.piclick.kr/sirs/ssunny_pc/' + productID + '?uid=' + self.uid + '&cookieID=' + self.uid + '&contentUrl=' + mainImgUrl;
    iframe.width = "100%";
    iframe.display = 'none';
    iframe.height = "0px";
    ...
    $('.title_detail:first').after(piclick_div);
  ...
  sirsMobile2: function (productID, mainImgUrl, referer) {
    ...
    var iframe = document.createElement('iframe');
    iframe.id = 'piclick-sirs-iframe';
    iframe.src = 'https://ai.piclick.kr/sirs/ssunny/' + productID + '?uid=' + self.uid + '&cookieID=' + self.uid + '&contentUrl=' + mainImgUrl;
    iframe.width = "100%";
    iframe.display = 'none';
    iframe.height = "0px";
    iframe.frameBorder = "0";
...
if (window.location.href.indexOf('shopdetail.html') > -1 || window.location.href.indexOf('/m/product.html') > -1) {
  ...
  const mainImgTag = '.detail_image';

  if (piclick.device == 'pc' && !document.querySelector('.response100')) {
