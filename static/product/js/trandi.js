...
Piclick.prototype = {
  ...
  sirsPC2: function(productID, mainImgUrl, referer){
    ...
    iframe.src = 'https://ai.piclick.kr/sirs/trandi_pc/' + productID + '?uid=' + self.uid + '&cookieID=' + self.uid + '&contentUrl=' + mainImgUrl;
    iframe.width = "100%";
    iframe.display = 'none';
    iframe.height = "0px";
    ...
    $('.d1-product-detail').after(piclick_div);
  ...
  sirsMobile2: function (productID, mainImgUrl, referer) {
    ...
    var iframe = document.createElement('iframe');
    iframe.id = 'piclick-sirs-iframe';
    iframe.src = 'https://ai.piclick.kr/sirs/trandi/' + productID + '?uid=' + self.uid + '&cookieID=' + self.uid + '&contentUrl=' + mainImgUrl;
    iframe.width = "100%";
    iframe.display = 'none';
    iframe.height = "0px";
    iframe.frameBorder = "0";
    ...
    $('.d1-product-detail').after(iframe);
